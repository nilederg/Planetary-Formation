...
fun main(args: Array<String>) {
    ...
    println(planet.terrain.getPoint(GeoCoord(Math.toRadians(40.0), Math.toRadians(32.0))))
    println(planet.terrain.getPoint(GeoCoord(Math.toRadians(40.0), Math.toRadians(50.0))))
